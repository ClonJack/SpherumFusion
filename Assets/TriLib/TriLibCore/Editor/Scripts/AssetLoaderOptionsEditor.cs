...
namespace TriLibCore.Editor
{
    ...
    public class AssetLoaderOptionsEditor : UnityEditor.Editor
    {
        ...
        public static void ShowInspectorGUI(SerializedObject serializedObject, ref int currentTab)
        {
            ...
            if (GUILayout.Toggle(currentTab == 6, "Custom Ring", "LargeButtonRight"))
            {
                currentTab = 6;
            }
            ...
            switch (currentTab)
            {
                case 0:
                    ...
                    EditorGUILayout.PropertyField(serializedObject.FindProperty("UseFileScale"),
                        new GUIContent("Use File Scale", "Turn on this flag to use the file original scale."));
                    EditorGUILayout.PropertyField(serializedObject.FindProperty("ImportVisibility"),
                        new GUIContent("Import Visibility",
                    ...
                    EditorGUILayout.PropertyField(serializedObject.FindProperty("ImportCameras"),
                        new GUIContent("Import Cameras", "Turn on this field to enable Cameras importing."));
                    EditorGUILayout.PropertyField(serializedObject.FindProperty("ImportLights"),
                        new GUIContent("Import Lights", "Turn on this field to enable Lights importing."));
                    EditorGUILayout.PropertyField(serializedObject.FindProperty("Static"),
                        new GUIContent("Import as Static",
                    ...
                    EditorGUILayout.PropertyField(serializedObject.FindProperty("SortHierarchyByName"),
                        new GUIContent("Sort Hierarchy by Name",
                    ...
                    EditorGUILayout.PropertyField(serializedObject.FindProperty("AddAssetUnloader"),
                        new GUIContent("Add Asset Unloader",
                            "Turn on this field to add the Asset Unloader Component to the loaded Game Object."));
                    EditorGUILayout.PropertyField(serializedObject.FindProperty("ShowLoadingWarnings"),
                        new GUIContent("Show Loading Warnings",
                    ...
                    EditorGUILayout.PropertyField(serializedObject.FindProperty("CloseStreamAutomatically"),
                        new GUIContent("Close Stream Automatically",
                    ...
                    EditorGUILayout.PropertyField(serializedObject.FindProperty("DestroyOnError"),
                        new GUIContent("Destroy on Error",
                    ...
                    EditorGUILayout.PropertyField(serializedObject.FindProperty("Timeout"),
                        new GUIContent("Timeout", "Model loading timeout in seconds (0=disabled)."));
                    EditorGUILayout.PropertyField(serializedObject.FindProperty("PivotPosition"),
                        new GUIContent("Pivot Position",
                            "Use this field to realign the Model pivot based on the given value."));
                    EditorGUILayout.PropertyField(serializedObject.FindProperty("DisableObjectsRenaming"),
                        new GUIContent("Disable Objects Renaming", "Turn on this field to disable objects renaming."));
                    EditorGUILayout.PropertyField(serializedObject.FindProperty("MergeSingleChild"),
                        new GUIContent("Merge Single Child",
                    ...
                    if (importMeshesProperty.boolValue)
                    {
                        EditorGUILayout.PropertyField(serializedObject.FindProperty("MarkMeshesAsDynamic"),
                            new GUIContent("Mark Meshes as Dynamic",
                        ...
                        EditorGUILayout.PropertyField(generateCollidersProperty,
                            new GUIContent("Generate Colliders",
                        ...
                        if (generateCollidersProperty.boolValue)
                        {
                            EditorGUILayout.PropertyField(serializedObject.FindProperty("ConvexColliders"),
                                new GUIContent("Convex Colliders",
                        ...
                        EditorGUILayout.PropertyField(importNormalsProperty,
                            new GUIContent("Import Normals",
                                "Turn on this field to import Mesh normals. If not enabled, normals will be calculated instead."));
                        ...
                        if (generateNormalsProperty.boolValue)
                        {
                            EditorGUILayout.PropertyField(generateNormalsProperty,
                                new GUIContent("Generate Normals",
                                    "Turn off this field to disable Mesh normals generation."));
                            var useUnityNativeNormalCalculatorProperty =
                                serializedObject.FindProperty("UseUnityNativeNormalCalculator");
                            EditorGUILayout.PropertyField(useUnityNativeNormalCalculatorProperty,
                                new GUIContent("Use Unity Native Normal Calculator",
                                    "Turn on this field to use the builtin Unity normal calculator."));
                        ...
                        if (importBlendShapesProperty.boolValue)
                        {
                            EditorGUILayout.PropertyField(serializedObject.FindProperty("ImportBlendShapeNormals"),
                                new GUIContent("Import Blend Shape Normals",
                        ...
                        EditorGUILayout.PropertyField(importTangentsProperty,
                            new GUIContent("Import Tangents",
                                "Turn on this field to import Mesh tangents. If not enabled, tangents will be calculated instead."));
                        EditorGUILayout.PropertyField(serializedObject.FindProperty("GenerateTangents"),
                            new GUIContent("Generate Tangents",
                        ...
                        EditorGUILayout.PropertyField(
                            serializedObject.FindProperty("LODScreenRelativeTransitionHeightBase"),
                    ...
                    EditorGUILayout.PropertyField(loadPointCloudsProperty,
                        new GUIContent("Load Point Clouds",
                            "TTurn on this field to load the model as a Point Cloud (PLY and OBJ only)"));
                ...
                case 1:
                    ...
                    switch (animationType)
                    {
                            ...
                            switch (avatarDefinitionType)
                            {
                                case AvatarDefinitionType.CreateFromThisModel:
                                    if (animationType == AnimationType.Humanoid)
                                    {
                                        ...
                                        EditorGUILayout.PropertyField(
                                            serializedObject.FindProperty("HumanoidAvatarMapper"),
                        ...
                        case AnimationType.Legacy:
                            EditorGUILayout.PropertyField(
                                serializedObject.FindProperty("AutomaticallyPlayLegacyAnimations"),
                            ...
                            EditorGUILayout.PropertyField(
                                serializedObject.FindProperty("EnforceAnimatorWithLegacyAnimations"),
                ...
                case 3:
                    ...
                    if (importMaterialsProperty.boolValue)
                    {
                        ...
                        EditorGUILayout.PropertyField(serializedObject.FindProperty("MaterialMappers"),
                            new GUIContent("Material Mappers",
                ...
                case 4:
                    ...
                    {
                        EditorGUILayout.PropertyField(serializedObject.FindProperty("TextureMapper"),
                            new GUIContent("Deprecated: Texture Mapper",
                                "Mapper used to find native Texture Streams from custom sources."));
                        EditorGUILayout.PropertyField(serializedObject.FindProperty("TextureMappers"),
                            new GUIContent("Texture Mappers",
                        ...
                        EditorGUILayout.PropertyField(serializedObject.FindProperty("DiscardUnusedTextures"),
                            new GUIContent("Discard Unused Textures", "Turn off this field to keep unused Textures."));
                        ...
                        EditorGUILayout.PropertyField(
                            serializedObject.FindProperty("ConvertMaterialTexturesUsingHalfRes"),
                            new GUIContent("Convert Material Textures using Half Res",
                                "Turn off this field to generate the \"Metallic/Smoothness/Specular/Roughness\" textures with the full original resolution."));
                    }

                    break;
                case 5:
                    EditorGUILayout.PropertyField(serializedObject.FindProperty("ExternalDataMapper"),
                        new GUIContent("External Data Mapper",
                    ...
                    EditorGUILayout.PropertyField(serializedObject.FindProperty("UserPropertiesMapper"),
                        new GUIContent("User Properties Mapper",
