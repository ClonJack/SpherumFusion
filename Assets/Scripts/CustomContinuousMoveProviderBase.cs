...
namespace Spherum
{
    public abstract class CustomContinuousMoveProviderBase : LocomotionProvider
    {
        ...
        [SerializeField]
        [Tooltip(
            "Controls whether gravity affects this provider when a Character Controller is used and flying is disabled.")]
        ...
        [SerializeField] [Tooltip("Controls when gravity begins to take effect.")]
        ...
        [SerializeField] [Tooltip("The source Transform to define the forward direction.")]
        ...
        protected virtual void Update()
        {
            ...
            switch (m_GravityApplicationMode)
            {
                ...
                default:
                    Assert.IsTrue(false,
                        $"{nameof(m_GravityApplicationMode)}={m_GravityApplicationMode} outside expected range.");
                    break;
            }
        ...
        protected virtual Vector3 ComputeDesiredMove(Vector2 input)
        {
            ...
            var speedFactor =
                m_MoveSpeed * Time.deltaTime * originTransform.localScale.x; // Adjust speed with user scale
